class Register:
    ...
    bc = property(lambda self: self._get_16('b', 'c'), lambda self, value: self._set_16('b', 'c', value), doc='BC reg')
    de = property(lambda self: self._get_16('d', 'e'), lambda self, value: self._set_16('d', 'e', value), doc='DE reg')
    hl = property(lambda self: self._get_16('h', 'l'), lambda self, value: self._set_16('h', 'l', value), doc='HL reg')
